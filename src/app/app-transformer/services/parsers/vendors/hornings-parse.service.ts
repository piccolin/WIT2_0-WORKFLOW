/**
 * @Filename:    hornings-parse.service.ts
 * @Type:        Service
 * @Date:        2025-12-17
 *
 * @Description:
 *   Vendor-specific PARSER stage for Hornings.
 *
 *   Layman explanation:
 ...
 *
 *   Coder’s note:
 *   This service is intentionally thin. All “Hornings rules” live in HorningsPdfExtractor,
...
export class HorningsParseService extends ParserBaseService {
  ...
  private getFileFromRequest(request: TransformationRequest): File {
    ...
    if (!(candidate instanceof File)) {
      throw new PdfParseError(
        'NO_FILE',
        'Hornings parser expected an uploaded PDF File on the request (e.g., request.file or request.payload.file).'
      );
    }
