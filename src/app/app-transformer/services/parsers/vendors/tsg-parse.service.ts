 ...
 *
 * @Description:
 *   Vendor-specific PARSER stage for TSG.
 *
 *   Layman explanation:
 ...
 *
 *   Coder’s note:
 *   This service is intentionally thin. All “TSG rules” live in TsgPdfExtractor
  ...
  private getFileFromRequest(request: TransformationRequest): File {
    ...
    if (!(candidate instanceof File)) {
      throw new PdfParseError(
        'NO_FILE',
        'TSG parser expected an uploaded PDF File on the request (e.g., request.file or request.payload.file).'
      );
    }
