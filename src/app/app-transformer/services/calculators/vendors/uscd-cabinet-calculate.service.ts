/**
 * @Filename:    uscd-calculate.service.ts
 * @Type:        Service
 * @Date:        2025-12-17
 *
 * @Description:
 *   Computes derived values for Uscd (totals, rollups, etc.).
 */
...
export class UsCabinetDepotCalculateService extends CalculatorBaseService {
