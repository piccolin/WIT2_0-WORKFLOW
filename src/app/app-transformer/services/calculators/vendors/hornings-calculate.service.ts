/**
 * @Filename:    hornings-calculate.service.ts
 * @Type:        Service
 * @Date:        2025-12-17
 *
 * @Description:
 *   Computes derived values for hornings (totals, rollups, etc.).
 */
...
export class HorningsCalculateService extends CalculatorBaseService {
