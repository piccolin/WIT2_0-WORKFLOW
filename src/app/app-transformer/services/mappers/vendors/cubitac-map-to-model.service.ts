/**
 * @Filename:    cubitac-map-to-model.service.ts
 * @Type:        Service
 * @Date:        2025-12-17
 *
 * @Description:
 *   Maps the processed Cubitac object into our canonical DB schema as a Partial<...>.
 */
...
export class CubitacMapToModelService extends MapperBaseService {
