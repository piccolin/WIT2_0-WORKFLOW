/**
 * @Filename:    wolf-default-value.service.ts
 * @Type:        Service
 * @Date:        2025-12-17
 *
 * @Description:
 *   Applies missing-value defaults for Wolf inputs without overwriting real values.
 */
...
export class WolfDefaultValueService extends DefaulterBaseService {
